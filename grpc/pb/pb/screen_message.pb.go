...
type Screen struct {
	...
	Repeated   *Screen_Resolution `protobuf:"bytes,2,opt,name=repeated,proto3" json:"repeated,omitempty"`
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=rahi.pcbook.Screen_Panel" json:"panel,omitempty"`
...
func (x *Screen) GetRepeated() *Screen_Resolution {
	if x != nil {
		return x.Repeated
	}
	return nil
...
var file_screen_message_proto_rawDesc = []byte{
	...
	,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: rahi.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: rahi.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: rahi.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: rahi.pcbook.Screen.repeated:type_name -> rahi.pcbook.Screen.Resolution
	0, // 1: rahi.pcbook.Screen.panel:type_name -> rahi.pcbook.Screen.Panel
