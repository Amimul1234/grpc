...
var file_laptop_message_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x88, 0x04, 0x0a, 0x06, 0x4c, 0x61, 0x70,
	...
	0x18, 0x06, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63,
	...
	0x32, 0x14, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x32, 0x13, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x53,
	...
	0x15, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x4b, 0x65,
	...
	0x67, 0x68, 0x74, 0x42, 0x1c, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e,
...
var file_laptop_message_proto_goTypes = []interface{}{
	...
	(*GPU)(nil),                   // 3: rahi.pcbook.GPU
	(*Storage)(nil),               // 4: rahi.pcbook.Storage
	(*Screen)(nil),                // 5: rahi.pcbook.Screen
	(*Keyboard)(nil),              // 6: rahi.pcbook.Keyboard
...
var file_laptop_message_proto_depIdxs = []int32{
	...
	3, // 2: rahi.pcbook.Laptop.gpus:type_name -> rahi.pcbook.GPU
	4, // 3: rahi.pcbook.Laptop.storages:type_name -> rahi.pcbook.Storage
	5, // 4: rahi.pcbook.Laptop.screen:type_name -> rahi.pcbook.Screen
	6, // 5: rahi.pcbook.Laptop.keyboard:type_name -> rahi.pcbook.Keyboard
	7, // 6: rahi.pcbook.Laptop.updated_at:type_name -> google.protobuf.Timestamp
