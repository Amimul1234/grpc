...
type Memory struct {
	...
	Unit  Memory_Unit `protobuf:"varint,2,opt,name=unit,proto3,enum=rahi.pcbook.Memory_Unit" json:"unit,omitempty"`
}
...
var file_memory_message_proto_rawDesc = []byte{
	...
	0x28, 0x0e, 0x32, 0x18, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x10, 0x06, 0x42, 0x1c, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70,
...
var file_memory_message_proto_goTypes = []interface{}{
	(Memory_Unit)(0), // 0: rahi.pcbook.Memory.Unit
	(*Memory)(nil),   // 1: rahi.pcbook.Memory
}
var file_memory_message_proto_depIdxs = []int32{
	0, // 0: rahi.pcbook.Memory.unit:type_name -> rahi.pcbook.Memory.Unit
