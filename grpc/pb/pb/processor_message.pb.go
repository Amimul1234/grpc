...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x72, 0x61, 0x68, 0x69, 0x2e,
	...
	0x6f, 0x72, 0x79, 0x52, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x1c, 0x0a, 0x12, 0x63,
	0x6f, 0x6d, 0x2e, 0x72, 0x61, 0x68, 0x69, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e, 0x70,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: rahi.pcbook.CPU
	(*GPU)(nil),    // 1: rahi.pcbook.GPU
	(*Memory)(nil), // 2: rahi.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: rahi.pcbook.GPU.memory:type_name -> rahi.pcbook.Memory
